...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "daemons", "anti2api", "colab_s3_neon", "scrcpy_vdo", "ask_claude_google", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
         ...
         {
               {
                  ...
                  forced_width = 120,   -- ← 这里改宽度！48~60 都好点
                  align  = 'center',
               },
               left   = 8,
               right  = 8,
...
globalkeys = gears.table.join(
    awful.key({ modkey }, "d", function () awful.spawn("rofi -show drun -show-icons") end,
          {description = "显示所有APP", group = "launcher"}),
    awful.key({ modkey }, "\\", treetile.horizontal),
